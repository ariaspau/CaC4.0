...
--
-- Servidor: localhost
-- Tiempo de generación: 04-01-2023 a las 16:33:37
...
CREATE TABLE `pedidos` (
  ...
  `lugarentrega` varchar(70) NOT NULL,
  `localidad` int(11) NOT NULL,
  `provincia` int(11) NOT NULL,
  `codpostal` varchar(80) NOT NULL,
...
(2, 'paulaarias@gmail.com', '808080', 'Paula Arias'),
(3, 'miemail@gmail.com', 'holaholahola', 'Yanina Suarez');
